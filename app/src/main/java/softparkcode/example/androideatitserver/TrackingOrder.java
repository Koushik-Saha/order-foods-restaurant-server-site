...
import softparkcode.example.androideatitserver.Common.DirectionJSONParser;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
        ...
        mService.getGeoCode(address).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try{
                    ...
                    bitmap = Common.scanleBitmap(bitmap,70,70);
    ...
    private class ParserTask extends AsyncTask<String,Integer, List<List<HashMap<String,String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> lists) {
            ...
            PolygonOptions lineOptions=null;


            for (int i=0;i<lists.size();i++)
            {
                points = new ArrayList();
                lineOptions = new PolygonOptions();
                ...
                lineOptions.strokeWidth(12);
                lineOptions.fillColor(Color.RED);
